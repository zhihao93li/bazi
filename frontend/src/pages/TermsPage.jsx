...
const sections = [
    {
        title: '服务概述',
        content: '欢迎使用八字命理 AI 分析服务（以下简称"本服务"）。本服务由我们提供，旨在利用传统八字命理学与现代人工智能技术，为用户提供个性化的命理分析报告。使用本服务即表示您同意遵守本服务条款。'
    },
    {
        title: '服务内容',
        content: '本服务包括但不限于：',
    ...
    {
        title: '争议解决',
        content: '本服务条款的解释和执行均适用中华人民共和国法律。如发生争议，双方应首先友好协商解决；协商不成的，任何一方均可向我们所在地的人民法院提起诉讼。'
    },
    {
        title: '条款更新',
    ...
    {
        title: '联系方式',
        content: '如您对本服务条款有任何疑问，请通过以下方式联系我们：support@bazi.ai'
    }
]
